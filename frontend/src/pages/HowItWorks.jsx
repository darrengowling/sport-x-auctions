              ...
              <div key={index} className="relative">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-4 flex-1">
                    ...
                    <button
                      onClick={step.action}
                      className={`${step.color} hover:opacity-90 text-white px-4 py-2 rounded-lg text-sm font-medium transition-all transform hover:scale-105 active:scale-95 flex items-center space-x-2 shadow-lg`}
                    >
                      <Play className="w-4 h-4" />
                      <span>{step.actionText}</span>
                    </button>
